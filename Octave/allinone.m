...
# (4)
coeffs4 = polyfit(1:sizeItRegFal, itRegFal, 5);
# Novo intervalo
...
plot(1:sizeItNewRap, itNewRap, 'marker', 'o', 'markersize', 9, 'linestyle', 'none', "markerfacecolor", 'g', "markeredgecolor", 'none');
plot(t3, y_fit3, 'b', 'linewidth', 2);
plot(1:sizeItPonFi, itPonFi, 'marker', 'o', 'markersize', 9, 'linestyle', 'none', "markerfacecolor", 'b', "markeredgecolor", 'none');
plot(t4, y_fit4, 'k', 'linewidth', 2);
plot(1:sizeItRegFal, itRegFal, 'marker', 'o', 'markersize', 9, 'linestyle', 'none', "markerfacecolor", 'k', "markeredgecolor", 'none');
plot(t5, y_fit5, 'c', 'linewidth', 2);
plot(1:sizeItSecante, itSecante, 'marker', 'o', 'markersize', 9, 'linestyle', 'none', "markerfacecolor", 'c', "markeredgecolor", 'none');
hold off
ylabel("ERR(n) - Erro Relativo Real", "fontweight", "b");
xlabel("n - número da iteração", "fontweight", "b");
legend('Ajuste B', 'ERR Bisseção', 'Ajuste NR', 'ERR Newton-Raphson', 'Ajuste PF', 'ERR Ponto Fixo', 'Ajuste RF', 'ERR Regula Falsi', 'Ajuste S', 'ERR Secante');
